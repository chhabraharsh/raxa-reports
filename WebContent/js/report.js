...
currentReportName="";
	...
	function generateReportpati(reportName,provider_id) {
		////&MyParam=ParamValue&invokesubmit=true
		//	here relative url is given if relative url is not working try giving full url
		var reporturl ="/BirtIntegration/loadReport?ReportName="+reportName+"&creator="+provider_id+"&ReportFormat=html";
